...
let perimter = width + width + height + height
print(perimter)
...
print("The result of integer divison of 10 divided by 3 is 3")
...
print("The value is different because doubles use deciaml numbers and integers use whole numbers")
/*:
...
print("\(even % 2)")
print("\(odd % 2)")
print("If there is no remainder the integer is even if there is a remainder the integer is odd")
/*:
